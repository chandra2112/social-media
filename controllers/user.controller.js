...
const registerUser = asyncHandler(async (req, res) => {
  ...
  if (!createUser) {
    throw new ApiError(200, "something went wrong while registering the user");
  }
...
const updateUserAvatar = asyncHandler(async (req, res) => {
  ...
  if (!avatar.url) {
    throw new ApiError(400, "Error while uploading on avarta");
  }
...
const updateUserCoverImage = asyncHandler(async (req, res) => {
  ...
  const deleteFromCloudinary = await deleteOnCloudinary(oldCoverImage);
